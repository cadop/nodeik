...
static vec3 quat_decompose(quat var_q)
{
        //---------
    // primal vars
...
static void adj_quat_decompose(quat var_q,
	quat & adj_q,
	vec3 & adj_ret)
{
        //---------
...
static quat quat_twist(vec3 var_axis,
	quat var_q)
{
        //---------
    // primal vars
...
static void adj_quat_twist(vec3 var_axis,
	quat var_q,
	vec3 & adj_axis,
	quat & adj_q,
	quat & adj_ret)
...
void eval_articulation_fk_cpu_kernel_forward(launch_bounds_t dim,
...
void eval_articulation_fk_cpu_kernel_backward(launch_bounds_t dim,
	array_t<int32> var_articulation_start,
	array_t<int32> var_articulation_mask,
	array_t<float32> var_joint_q,
	array_t<float32> var_joint_qd,
...
WP_API void eval_articulation_fk_cpu_forward(launch_bounds_t dim,
	array_t<int32> var_articulation_start,
	array_t<int32> var_articulation_mask,
	array_t<float32> var_joint_q,
	array_t<float32> var_joint_qd,
	...
	array_t<spatial_vector> var_body_qd)
{
    ...
    for (int i=0; i < dim.size; ++i)
    {
        ...
        eval_articulation_fk_cpu_kernel_forward(dim,
...
WP_API void eval_articulation_fk_cpu_backward(launch_bounds_t dim,
	array_t<int32> var_articulation_start,
	array_t<int32> var_articulation_mask,
	array_t<float32> var_joint_q,
	array_t<float32> var_joint_qd,
	...
	array_t<spatial_vector> adj_body_qd)
{
    ...
    for (int i=0; i < dim.size; ++i)
    {
        ...
        eval_articulation_fk_cpu_kernel_backward(dim,
			var_articulation_start,
			var_articulation_mask,
			var_joint_q,
			var_joint_qd,
...
void eval_articulation_ik_cpu_kernel_forward(launch_bounds_t dim,
	array_t<transform> var_body_q,
	array_t<spatial_vector> var_body_qd,
	array_t<vec3> var_body_com,
	array_t<int32> var_joint_type,
...
void eval_articulation_ik_cpu_kernel_backward(launch_bounds_t dim,
	array_t<transform> var_body_q,
	array_t<spatial_vector> var_body_qd,
	array_t<vec3> var_body_com,
	array_t<int32> var_joint_type,
...
// Python CPU entry points
WP_API void eval_articulation_ik_cpu_forward(launch_bounds_t dim,
	array_t<transform> var_body_q,
	array_t<spatial_vector> var_body_qd,
	array_t<vec3> var_body_com,
	array_t<int32> var_joint_type,
	...
	array_t<float32> var_joint_qd)
{
    ...
    for (int i=0; i < dim.size; ++i)
    {
        ...
        eval_articulation_ik_cpu_kernel_forward(dim,
			var_body_q,
			var_body_qd,
			var_body_com,
			var_joint_type,
...
WP_API void eval_articulation_ik_cpu_backward(launch_bounds_t dim,
	array_t<transform> var_body_q,
	array_t<spatial_vector> var_body_qd,
	array_t<vec3> var_body_com,
	array_t<int32> var_joint_type,
	...
	array_t<float32> adj_joint_qd)
{
    ...
    for (int i=0; i < dim.size; ++i)
    {
        ...
        eval_articulation_ik_cpu_kernel_backward(dim,
			var_body_q,
			var_body_qd,
			var_body_com,
			var_joint_type,
