...
class RobotDual():
    def __init__(self, render=True, num_envs=1, device='cpu', robot_path='dyros_tocabi.urdf',start_joint_index=0, ee1_link_name='L_Wrist1_Link', ee2_link_name='R_Wrist2_Link'):
        builder = wp.sim.ModelBuilder()
